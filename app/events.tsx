...
//       // Use user's coordinates in the API call
//       const url = `https://api.predicthq.com/v1/events?within=4.05mi%40${latitude}%2C${longitude}&limit=1000&sort=start&start.gte=2024-10-23&category=${attendedCategories.join(',')}`;
...
const API_KEY = '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'; // Replace with your OpenAI API key
